...
// ACP hooks
$plugins->add_hook('admin_user_menu', 'credits_admin_menu');
$plugins->add_hook('admin_user_action_handler', 'credits_admin_action_handler');
$plugins->add_hook('admin_user_permissions', 'credits_admin_permissions');
